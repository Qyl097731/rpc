...
public class LoadBalanceLru implements LoadBalance {
    ...
    private Map<String, Map<RpcPeer,RpcPeer>> cache = new ConcurrentHashMap<> ();
    ...
    public RpcPeer doRoute(String serviceName, List<RpcPeer> serviceProviders) {
         ...
         */
        Map<RpcPeer, RpcPeer> lruCache = cache.getOrDefault (serviceName,
        ...
        cache.putIfAbsent (serviceName,lruCache);
